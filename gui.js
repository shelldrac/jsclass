...
/****************************************************************************
****************************************************************************/
function CursorX(wc, w, h, b, be, x, callbackD, callbackU, callbackM, iw, ih, dx, dy, val, min, max, ste, extra) {
	Button.call(this, w, h, b, be);
	this.x = x;
	this.min = min;
	this.max = max;
	this.ste = ste;
	this.wc = wc;
	this.iniCur( wc, w, h, b, be, x, callbackD, callbackU, callbackM, iw, ih, dx, dy, val, extra);
}
CursorX.prototype = {
	...
	durMin : 50,
	durSte : 50,
	iniCur : function (wc, w, h, b, be, x, callbackD, callbackU, callbackM, iw, ih, dx, dy, val, extra) {
		var this_ = this, wel, wer, he, wc, cur, rai, envL, envR, envElm = [[], []], obj, i, c;
		obj = {
			l : function (arg1) {envElm[arg1].push(new ButtonImgPush(w, h, b, be, iw, ih, dx, dy, this_.imgLU, this_.imgLD, $obj.bind(this_, this_.stop, []), $obj.bind(this_, this_.move, [this_.durMax, - this_.toPer(this_.min + this_.ste)])));},
			r : function (arg1) {envElm[arg1].push(new ButtonImgPush(w, h, b, be, iw, ih, dx, dy, this_.imgRU, this_.imgRD, $obj.bind(this_, this_.stop, []), $obj.bind(this_, this_.move, [this_.durMax,   this_.toPer(this_.min + this_.ste)])));},
			c : function (arg1) {envElm[arg1[0]].push(new ButtonLab    (w, h, b, be, null, null, null, null))},
			u : function (arg1) {envElm[arg1[0]].push(new ButtonLab    (w, h, b, be, null, null, arg1[1], null));},
			i : function (arg1) {envElm[arg1].push(new ButtonLab    (w, h, b, be, null, null, this_.min, null));},
			a : function (arg1) {envElm[arg1].push(new ButtonLab    (w, h, b, be, null, null, this_.max, null));}
		};
		...
		//var o = new CursorX(400,30,30,2,5,null,null,null,null,10,10,null,null,null,'%',1,10{l:0,r:0,c:[0,0],u:[0,'%'],i:0,a:1});document.body.appendChild(o.rai);
		// this.btnL = new ButtonImgPush(w, h, b, be, iw, ih, dx, dy, this.imgLU, this.imgLD, $obj.bind(this, this.stop, []), $obj.bind(this, this.move, [this.durMax, - this.toPer(this.min + this.ste)]));
		// this.btnR = new ButtonImgPush(w, h, b, be, iw, ih, dx, dy, this.imgRU, this.imgRD, $obj.bind(this, this.stop, []), $obj.bind(this, this.move, [this.durMax,   this.toPer(this.min + this.ste)]));
		// this.btnC = new ButtonLab    (w, h, b, be, null, null, null, null);
		// this.btnU = new ButtonLab    (w, h, b, be, null, null, unit, null);
		// env.appendChild(this.btnL.elm);
		// env.appendChild(this.btnR.elm);
		// env.appendChild(this.btnC.elm);
		// env.appendChild(this.btnU.elm);
		$c(envElm);
	...
	stop  : function () {clearTimeout(this.count);},
	movePer : function (arg1) {
		if (arg1 < 0) {arg1 = 0;} else if (arg1 > 1) {arg1 = 1;}
		this.x = arg1;
		this.cur.style.marginLeft = Math.round(arg1 * this.railW) + 'px';
		// this.btnC.img.innerHTML = oNum.fix(this.toVal(this.x),0);
	},
...
var $$gui = {
	css : {
		'.btn2 .lab0' : {'color' : 'black'},
		'.btn2 .lab1' : {'color' : 'red'},
		'.ico0, .ico2' : {'border-style' : 'solid'},
		'.btn0,.btnD,.btnM,.btnT,.btnU,.btn1,.btn2,.lab0,.lab1' : {'overflow' : 'hidden', 'border-style': 'solid'},
		...
		'.icon' : {},
		'.labe' : {'overflow' : 'hidden', 'text-align' : 'center'},
		'.btn0 .icon, .btnM .icon' : {},
		'.btn0 .labe, .btnM .labe' : {},
